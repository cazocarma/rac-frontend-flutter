...
class CompaDetailScreen extends StatefulWidget {
  final CompaApi api;
  final String id;
  const CompaDetailScreen({super.key, required this.api, required this.id});
        ...
        child: error != null
            ...
            : c == null
                ...
                : Column(
                    ...
                    children: [
                      Text(c.nombre, style: Theme.of(context).textTheme.headlineSmall),
                      const SizedBox(height: 8),
                      Text('\$${c.tarifaHora.toStringAsFixed(0)}/h • ⭐ ${c.ratingPromedio.toStringAsFixed(1)}'),
                      const SizedBox(height: 8),
                      Text(c.habilidades.join(', ')),
